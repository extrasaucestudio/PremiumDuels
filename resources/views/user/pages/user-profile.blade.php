...
<div class="col">
    <div class="progress progress-sm mr-2">
        <div class="progress-bar bg-info" role="progressbar" style="width: {{$nextRank->percent}}%"
            aria-valuenow="{{$nextRank->percent}}" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
</div>
</div>
</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Rank Progress
                    </div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$user->Title->name}} | {{$nextRank->percent}}%
                    </div>
                </div>
                <div class="col-auto">
                    <i class="fas fa-fist-raised fa-2x text-gray-300"></i>
