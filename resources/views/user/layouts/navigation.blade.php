...
<head>
    ...
    <title>Premium Duels - User Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3" style="font-family: 'Saira Stencil One', cursive;">Premium Duels
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/user/inventory/switch">Switch</a>
                        <h6 class="collapse-header">School:</h6>
                        @if($user->School == null)
                        <a class="collapse-item" href="/user/school/create">Create</a>
                        @else
                        @if($user->School->MemberToSchool->SchoolOwner->id == $user->id)
                        <a class="collapse-item" href="/user/school/panel">School Panel</a>
                        <a class="collapse-item" href="/user/school/view">My School</a>
                        @else
                        <a class="collapse-item" href="/user/school/view">My School</a>
                        @endif
                        @endif
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/user/leaderboard">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle"
                                            src="https://cdn.discordapp.com/emojis/596847826479349760.png?v=1" alt="">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div>
